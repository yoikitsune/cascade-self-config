...
Rien — toutes les phases de la mise en conformité ADR-0001 sont terminées.

## Ce qui est prévu

Rien — toutes les phases de la mise en conformité ADR-0001 seront terminées après la Phase 4.
